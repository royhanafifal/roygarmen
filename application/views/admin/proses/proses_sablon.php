...
<body>
    <div class="wrapper">
        ...
        <?php if($id_order){?>
            <form action="<?php echo base_url('proses/update_sablon');?>" method="post" enctype="multipart/form-data">
                ...
                ?>
                <br>
                <img src="<?php echo base_url().'assets/images/'.$foto ?>" class="img-responsive" alt="Foto Sablon">
                <br><br>
