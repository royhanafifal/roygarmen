...
<body>
    <div class="wrapper">
        ...
        <h3>Proses Penjahitan</h3>
        <?php $this->load->view("admin/_partials/breadcrumb.php") ?>

        <?php if($id_order){?>
            <form action="<?php echo base_url('proses/update_penjahitan');?>" method="post" enctype="multipart/form-data">
                ...
                ?>
                <br>
                <img src="<?php echo base_url().'assets/images/'.$foto ?>" class="img-responsive" alt="Foto Penjahitan">
                <br><br>
        ...
        <?php }else{ ?>
            <form action="<?php echo base_url('proses/save_penjahitan');?>" method="post" enctype="multipart/form-data">
